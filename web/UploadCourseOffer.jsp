                    ...
                    <div class="container">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <center>
                                    <h5>Things you should keep in mind before uploading <strong class="red-text">Course Offer File</strong>.</h5>
                                </center>
                            </div>
                            ...
                            <div class="card-content white">
                                <div id="test4">
                                    <ul class="list-styled">
                                        <li>File name should not start with numbers <b>e.g. 1courseOffer</b>.</li><br>
                                        <li>File should not contain hyphen <b>e.g. course-Offer</b></li><br>
                        ...
                        <form  action="UploadCourseOfferServlet" method="post" enctype="multipart/form-data">
