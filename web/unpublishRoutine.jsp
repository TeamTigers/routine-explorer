    ...
    <body>
        ...
        <div id="main">
            <div class="wrapper">
                ...
                <form name="myForm" action="unpublishRoutine" method="post">      
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <label class="teal-text" style="font-size: 15px; font-weight: bolder; margin-left: 1%;"> Select routine version to unpublish </label>
                        </div>
                    </div>
                    <br>
                    <center>
