        ...
        <div id="main">
            ...
            <div class="wrapper">
                    ...
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <li class="bold">
                            <a href="ViewBugForTeacher.jsp" class="waves-effect waves-cyan">
                                ...
                                <span class="nav-text">View Bug for Teachers</span>
                            </a>
                        </li>
                        ...
                        <li class="active bold">
                            <a href="ViewBugForStudent.jsp" class="waves-effect waves-cyan">
                                ...
                                <span class="nav-text">View Bug for Students</span>
                            </a>
                        </li>
                        <li class="bold">
                ...
                <%
                    ...
                    rs = st.executeQuery("select * from ExcelFileName ORDER BY FileID DESC");
                %>

                <form name="myForm" action="Bug_Student" method="post">      
                    <div class="row">
                         <div class="input-field col s12">
                                ...
                                <label class="teal-text" style="font-size: 15px; font-weight: bolder; margin-left: 1%;">Select routine version</label>
                         </div>
                    </div>
                    <br>
                    <center>
                        <button class="btn waves-effect waves-light z-depth-1 cyan darken-1  border-round" style="font-weight: bolder" type="submit" name="submit">Explore
