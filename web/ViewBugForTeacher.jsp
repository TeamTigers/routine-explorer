    ...
    <body>
        ...
        <div id="main">
            ...
            <div class="wrapper">
                ...
                <form name="myForm" action="Bug_Teacher" method="post">      
                       <div class="row">
                        ...
                        <center>
                            <button class="btn waves-effect waves-light cyan darken-1 border-round z-depth-1" style="font-weight: bolder" type="submit" name="submit">Explore
