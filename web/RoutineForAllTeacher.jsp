    ...
    <body>
        ...
        <div id="main">
            <div class="wrapper">
                ...
                <form name="myForm" action="ProcessAllTeacherRoutine" method="post">      
                       <div class="row">
                         <div class="input-field col s12">
                                    ...
                                    <label class="teal-text" style="font-size: 15px; font-weight: bolder; margin-left: 1%;"> Select version </label>
                         </div>
                       </div>
                        <br>
                        <center>
                            <button class="btn waves-effect waves-light cyan darken-1 border-round z-depth-1" style="font-weight: bolder" type="submit" name="submit">Submit
