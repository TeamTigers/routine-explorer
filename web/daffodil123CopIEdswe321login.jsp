<%-- 
    Document   : AdminLogin
    Created on : Jul 15, 2018, 10:08:54 AM
    Author     : Showrov
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css/loginDemo.css">

    </head>

    <body  onload="M.toast({html: 'Sorry!! Wrong username or password.', classes: 'rounded'})">

        <form action="LoginValidateServlet" method="post" autocomplete="off">
            ...
            <div class="input-field col s6">
                ...
                <input type="text" id="email" name="email" class="validate" maxlength="256" />
            ...
            <div class="input-field col s12">
                ...
                <input type="password" id="password" name="pass" class="validate" />
            ...
            <center>
                <button id="login" class="btn waves-effect waves-light" type="submit" name="action">Sign In
